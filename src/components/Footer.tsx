        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex space-x-4">
              ...
              <Linkedin className="h-5 w-5 hover:text-primary-glow cursor-pointer transition-colors" />
              <Github className="h-5 w-5 hover:text-primary-glow cursor-pointer transition-colors" />
              <Mail className="h-5 w-5 hover:text-primary-glow cursor-pointer transition-colors" />
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-primary-foreground/80">
              ...
              <li><a href="#" className="hover:text-primary-foreground transition-colors">Interview Prep</a></li>
            </ul>
          </div>
