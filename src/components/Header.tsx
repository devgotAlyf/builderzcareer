...
import { Menu, X, FileText, LogOut, User, Bookmark, Briefcase, Mail } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <a href="#home" className="text-foreground hover:text-primary hover:underline transition-colors">Home</a>
            ...
            <Link to="/contact" className="text-foreground hover:text-primary hover:underline transition-colors flex items-center gap-1">
        ...
        {isMenuOpen && <nav className="md:hidden mt-4 pb-4 border-t border-border pt-4">
            <div className="flex flex-col space-y-4">
              <a href="#home" className="text-foreground hover:text-primary hover:underline transition-colors">
                Home
              </a>
              <a href="#job-finder" className="text-foreground hover:text-primary hover:underline transition-colors">
                Job Finder
